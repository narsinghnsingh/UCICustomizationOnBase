report 50054 "SUBJOB CARD PRINTING&FINISHING"
{
    // version Production/Sadaf

    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Reports/SUBJOB CARD PRINTING&FINISHING.rdl';
    ...
    dataset
    {
        dataitem("Prod. Order Line"; "Prod. Order Line")
        {
            ...
            dataitem("Production Order"; "Production Order")
            {
                ...
                column(BLOCK_LOCATION; BLOCK_LOCATION)
                {
                }
                ...
                begin
                    ...
                    if EST_HEADER.FindFirst then begin
                        ...
                        FG_QTY := EST_HEADER."Quantity Per FG";
                        BLOCK_LOCATION := EST_HEADER."Plate Item Client";
            ...
            dataitem("Product Design Special Descrip"; "Product Design Special Descrip")
            {
                ...
                DataItemTableView = SORTING ("No.", "Line No.") ORDER(Ascending) WHERE (Category = FILTER ("Special Instruction" | "Sub Job Detail" | "Sp. Instruction SubJob Printing"));
            ...
            begin
                ...
                if EST_HEADER.FindFirst then begin
                    SUB_GSM := EST_HEADER."Customer GSM";
                end;
                //MESSAGE('%1',SUB_GSM)
            end;
        }
