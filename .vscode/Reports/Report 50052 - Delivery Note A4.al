report 50052 "Delivery Note A4"
{
    // version Sadaf

    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Reports/Delivery Note A4.rdl';
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        begin
                            ...
                            PACKING_LINE.SetRange(PACKING_LINE."Prod. Order No.", "Prod. Order No.");//Binay Kumar 07-09-15
                            ...
                            SALES_LINES.Reset;
                            SALES_LINES.SetRange(SALES_LINES."Document No.", "Ref. Sales Order No.");
                            SALES_LINES.SetRange(SALES_LINES."Line No.", "Ref. Sales Order Line No.");
