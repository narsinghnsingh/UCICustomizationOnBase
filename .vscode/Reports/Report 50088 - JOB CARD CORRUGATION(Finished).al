report 50088 "JOB CARD CORRUGATION(Finished)"
{
    // version Production/Sadaf/Firoz

    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Reports/JOB CARD CORRUGATION(Finished).rdl';
    ...
    dataset
    {
        dataitem("Prod. Order Line"; "Prod. Order Line")
        {
            ...
            dataitem("Prod. Order Component"; "Prod. Order Component")
            {
                ...
                DataItemTableView = SORTING (Status, "Prod. Order No.", "Prod. Order Line No.", "Line No.") ORDER(Ascending) WHERE ("Schedule Component" = CONST (false), "Substitute Item" = CONST (false));
