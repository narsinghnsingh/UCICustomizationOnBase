report 50105 "Delivery Note VAT Consolidate"
{
    // version Sales/Sadaf

    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Reports/Delivery Note VAT Consolidate.rdl';
    Caption = 'Delivery Note VAT Consolidate';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        column(Qty_SalesShptLine; TotalItemQty)
                        {
                        }
                        ...
                        begin
                            ...
                            TotalItemQty := "Sales Shipment Line".Quantity;
                            ...
                            ItemCode := "Sales Shipment Line"."No.";
                        end;
                        ...
                        begin
                            "Sales Shipment Line".SetCurrentKey("Sales Shipment Line"."No.");
                            MoreLines := Find('+');
