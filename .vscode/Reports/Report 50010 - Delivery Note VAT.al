report 50010 "Delivery Note VAT"
{
    // version Sales/Sadaf

    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Reports/Delivery Note VAT.rdl';
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            column(Cust_Code; "Sales Shipment Header"."Sell-to Customer No.")
            {
            }
            ...
            column(Transporter; "Sales Shipment Header"."Shipping Agent Code")
            {
            }
            column(DriverName_SalesShipmentHeader; "Sales Shipment Header"."Driver Name")
            {
            }
            column(ContactPerson; "Sales Shipment Header"."Sell-to Contact")
            {
            }
            column(Cust_FaxNo; FaxNo)
            {
            }
            column(CustPhonNo; PhonNo)
            {
            }
            ...
            column(ConsigneeCode; "Sales Shipment Header"."Ship-to Post Code")
            {
            }
            column(Origin; "Sales Shipment Header"."Sell-to Country/Region Code")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        column(NetWight; "Sales Shipment Line"."Net Weight")
                        {
                        }
                        ...
                        column(Description_SalesShptLine; Description + ' -  ' + '( ' + PailotDescription + ' ) ')
                        {
                        }
                        ...
                        column(UOM_SalesShptLine; "Sales Shipment Line"."Unit of Measure Code")
                        {
                        }
                        ...
                        column(Description_SalesShptLineCaption; FieldCaption(Description) + ' ' + PailotDescription + 'Pallets')
                        {
                        }
                        ...
                        column(AdditionalDesc; AdditionalDesc)
                        {
                        }
                        ...
                        begin
                            ...
                            SALES_COMMENTLINE.Reset;
                            SALES_COMMENTLINE.SetRange(SALES_COMMENTLINE."No.", "Document No.");
                            if SALES_COMMENTLINE.FindFirst then begin
                                repeat
                                    DESCR := SALES_COMMENTLINE.Comment;
                                until SALES_COMMENTLINE.Next = 0;
                            end else begin
                                DESCR := '';
                            end;
                            //MESSAGE(DESCR);
                            ...
                            if SALESCOMMENT = true then begin
                                TXT1 := "Sales Shipment Header"."Ship-to Post Code";
                                TXT2 := TerrifCode;
                                TXT3 := "Sales Shipment Header"."Sell-to Country/Region Code";
                                NETWT := "Sales Shipment Line"."Net Weight";
                                TXT5 := 'EMPTY CARTONS';
                            end else begin
                                TXT1 := '';
                                TXT2 := '';
            ...
            begin
                ...
                */
                ...
                ConactPerson := '';
                CustomerCard.Reset;
                CustomerCard.SetRange(CustomerCard."No.", "Sales Shipment Header"."Sell-to Customer No.");
                if CustomerCard.FindFirst then begin
                    ConactPerson := CustomerCard.Contact;
                    PhonNo := CustomerCard."Phone No.";
                    FaxNo := CustomerCard."Fax No.";
                end;
                ...
                SalesCommentLine.SetRange(SalesCommentLine."Document Type", SalesCommentLine."Document Type"::Shipment);
                SalesCommentLine.SetRange(SalesCommentLine."No.", "Sales Shipment Header"."No.");
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field("Do You Want To Print Comment?"; SALESCOMMENT)
                    {
                    }
    ...
    var
        ...
        ConactPerson: Text[60];
        PhonNo: Code[100];
        FaxNo: Code[200];
        UserTab: Record User;
        UserName: Text[60];
        SALES_COMMENTLINE: Record "Sales Comment Line";
        DESCR: Text[250];
        Item: Record Item;
        TerrifCode: Code[30];
        SALESCOMMENT: Boolean;
        TXT1: Text[250];
        TXT2: Text;
        TXT3: Text;
        NETWT: Decimal;
