report 50114 "Knock Off Detail Vendor"
{
    // version NAVW18.00

    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Reports/Knock Off Detail Vendor.rdl';
    Caption = 'Knock Off Detail Vendor';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING ("Document Type", "Vendor No.", "Posting Date", "Currency Code") WHERE ("Document Type" = FILTER (Payment | Refund | "Credit Memo"));
            ...
            column(SelltoCustomerNo_CustLedgerEntry; "Vendor Ledger Entry"."Buy-from Vendor No.")
            {
            }
            column(ChequeNo_CustLedgerEntry; "Vendor Ledger Entry"."Cheque No.")
            {
            }
            column(ChequeDate_CustLedgerEntry; Format("Vendor Ledger Entry"."Cheque Date"))
            {
            }
            ...
            dataitem(PageLoop; "Integer")
            {
                ...
                column(CustomerNo_CustLedgEntry; "Vendor Ledger Entry"."Vendor No.")
                {
                    IncludeCaption = true;
                }
                column(DocDate_CustLedgEntry; Format("Vendor Ledger Entry"."Document Date", 0, 4))
                {
                }
                ...
                column(DocumentNo_CustLedgEntry; "Vendor Ledger Entry"."Document No.")
                {
                }
                ...
                dataitem(DetailedCustLedgEntry1; "Detailed Vendor Ledg. Entry")
                {
                    ...
                    dataitem(CustLedgEntry1; "Vendor Ledger Entry")
                    {
                ...
                dataitem(DetailedCustLedgEntry2; "Detailed Vendor Ledg. Entry")
                {
                    DataItemLink = "Applied Vend. Ledger Entry No." = FIELD ("Entry No.");
                    DataItemLinkReference = "Vendor Ledger Entry";
                    DataItemTableView = SORTING ("Vendor Ledger Entry No.", "Entry Type", "Posting Date") WHERE (Unapplied = CONST (false));
                    dataitem(CustLedgEntry2; "Vendor Ledger Entry")
                    {
                ...
                dataitem(Total; "Integer")
                {
                    ...
                    column(CurrCode_CustLedgEntry; CurrencyCode("Vendor Ledger Entry"."Currency Code"))
                    {
                    }
                    column(OriginalAmt_CustLedgEntry; "Vendor Ledger Entry"."Original Amount")
                    {
                    }
                    column(ExtDocNo_CustLedgEntry; "Vendor Ledger Entry"."External Document No.")
                    {
                    }
            ...
            begin
                Cust.Get("Vendor No.");
                FormatAddr.Vendor(CustAddr, Cust);

                "Vendor Ledger Entry".CalcFields("Vendor Ledger Entry"."Vendor Name");
                CustName := "Vendor Ledger Entry"."Vendor Name";
