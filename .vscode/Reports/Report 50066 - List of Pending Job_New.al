report 50066 "List of Pending Job_New"
{
    // version Sales/Sadaf

    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Reports/List of Pending Job_New.rdl';
    ...
    dataset
    {
        dataitem("Sales Line"; "Sales Line")
        {
            ...
            RequestFilterFields = "Sell-to Customer No.", "Requested Delivery Date", "RPO Status";
            ...
            begin
                ...
                ItemLedgerEntry.SetFilter(ItemLedgerEntry."Item Category Code", 'BOARD');
                ItemLedgerEntry.SetRange(ItemLedgerEntry."Order No.", "Prod. Order No.");
                if ItemLedgerEntry.FindFirst then begin
                    output_qty := ItemLedgerEntry.Quantity;
                end;
            end;
        }
    }
