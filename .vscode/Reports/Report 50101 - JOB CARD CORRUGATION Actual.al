report 50101 "JOB CARD CORRUGATION Actual"
{
    // version Production/Sadaf

    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Reports/JOB CARD CORRUGATION Actual.rdl';
    ...
    dataset
    {
        dataitem("Prod. Order Line"; "Prod. Order Line")
        {
            ...
            dataitem("Production Order"; "Production Order")
            {
                ...
                column(Score1; Format(Score1) + '  +  ' + Format(Score2) + '  +  ' + Format(Score3) + '  +  ' + Format(Score4) + '  +  ' + Format(Score5))
                {
                }
                ...
                column(OrdeHeaderQty; "Production Order".Quantity)
                {
                }
                ...
                begin
                    ...
                    if SH.FindFirst then begin
                        ...
                        CUSTADD := SH."Ship-to Name";
                        CUSTADD1 := SH."Ship-to Address";
            ...
            dataitem("Prod. Order Component"; "Prod. Order Component")
            {
                ...
                DataItemTableView = SORTING (Status, "Prod. Order No.", "Prod. Order Line No.", "Line No.") ORDER(Ascending) WHERE ("Schedule Component" = CONST (false), "Substitute Item" = FILTER (false));
                ...
                column(POCompCost; "Prod. Order Component"."Cost Amount")
                {
                }
                ...
                begin
                    ...
                    */
                    //IF NOT "Prod. Order Component"."Substitute Item" THEN BEGIN
                    Item.Reset;
                    ...
                    //POCompCost := "Prod. Order Component"."Cost Amount";
            ...
            dataitem("Product Design Special Descrip"; "Product Design Special Descrip")
            {
                ...
                DataItemTableView = SORTING ("No.", "Line No.") ORDER(Ascending) WHERE (Category = FILTER ("Special Instruction" | "Special Instruction Corrugation" | "Sp. Instruction Main Corrugation "));
            ...
            dataitem("Item Ledger Entry"; "Item Ledger Entry")
            {
                ...
                DataItemTableView = SORTING ("Entry No.") ORDER(Descending) WHERE ("Entry Type" = FILTER (Consumption), "Item Category Code" = FILTER ('PAPER' | 'DUP_PAPER'));
                column(ItemNo_ItemLedgerEntry; "Item Ledger Entry"."Item No.")
                {
                }
                column(PaperPosition_ItemLedgerEntry; "Item Ledger Entry"."Paper Position")
                {
                }
                column(Description_ItemLedgerEntry; "Item Ledger Entry".Description)
                {
                }
                column(TakeUp_ItemLedgerEntry; "Item Ledger Entry"."Take Up")
                {
                }
                column(ILEFSCCategory; ILEFSCCategory)
                {
                }
                column(FluteType_ItemLedgerEntry; "Item Ledger Entry"."Flute Type")
                {
                }
                column(ILEGSM1; ILEGSM * "Item Ledger Entry"."Take Up")
                {
                }
                ...
                column(TotalILEGSM; TotalILEGSM)
                {
                }
                ...
                begin
                    ...
                    Item.SetFilter(Item."Inventory Posting Group", 'PAPER');
                    if Item.FindFirst then begin
                        ILEGSM := Item."Paper GSM";
                        ILEFSCCategory := Item."FSC Category";
                    end;

                    if ILEGSM_L1 = 0 then begin
                        Rec_ILEL1.Reset;
                        Rec_ILEL1.SetCurrentKey(Rec_ILEL1."Paper GSM");
                        Rec_ILEL1.SetRange(Rec_ILEL1."Item No.", "Item Ledger Entry"."Item No.");
                        Rec_ILEL1.SetRange(Rec_ILEL1."Order No.", "Item Ledger Entry"."Order No.");
                        Rec_ILEL1.SetRange(Rec_ILEL1."Order Line No.", "Item Ledger Entry"."Order Line No.");
                        Rec_ILEL1.SetRange(Rec_ILEL1."Paper Position", Rec_ILEL1."Paper Position"::Liner1);
                        if Rec_ILEL1.FindLast then begin
                            Item.Reset;
                            Item.SetRange(Item."No.", Rec_ILEL1."Item No.");
                            Item.SetFilter(Item."Inventory Posting Group", 'PAPER');
                            if Item.FindFirst then
                                ILEGSM_L1 := Item."Paper GSM" * Rec_ILEL1."Take Up";
                        end;
                    end;

                    if ILEGSM_F1 = 0 then begin
                        Rec_ILEF1.Reset;
                        Rec_ILEF1.SetCurrentKey(Rec_ILEF1."Paper GSM");
                        Rec_ILEF1.SetRange(Rec_ILEF1."Item No.", "Item Ledger Entry"."Item No.");
                        Rec_ILEF1.SetRange(Rec_ILEF1."Order No.", "Item Ledger Entry"."Order No.");
                        Rec_ILEF1.SetRange(Rec_ILEF1."Order Line No.", "Item Ledger Entry"."Order Line No.");
                        Rec_ILEF1.SetRange(Rec_ILEF1."Paper Position", Rec_ILEF1."Paper Position"::Flute1);
                        if Rec_ILEF1.FindLast then begin
                            Item.Reset;
                            Item.SetRange(Item."No.", Rec_ILEF1."Item No.");
                            Item.SetFilter(Item."Inventory Posting Group", 'PAPER');
                            if Item.FindFirst then
                                ILEGSM_F1 := Item."Paper GSM" * Rec_ILEF1."Take Up";
                        end;
                    end;

                    if ILEGSM_L2 = 0 then begin
                        Rec_ILEL2.Reset;
                        Rec_ILEL2.SetCurrentKey(Rec_ILEL2."Paper GSM");
                        Rec_ILEL2.SetRange(Rec_ILEL2."Item No.", "Item Ledger Entry"."Item No.");
                        Rec_ILEL2.SetRange(Rec_ILEL2."Order No.", "Item Ledger Entry"."Order No.");
                        Rec_ILEL2.SetRange(Rec_ILEL2."Order Line No.", "Item Ledger Entry"."Order Line No.");
                        Rec_ILEL2.SetRange(Rec_ILEL2."Paper Position", Rec_ILEL2."Paper Position"::Liner2);
                        if Rec_ILEL2.FindLast then begin
                            Item.Reset;
                            Item.SetRange(Item."No.", Rec_ILEL2."Item No.");
                            Item.SetFilter(Item."Inventory Posting Group", 'PAPER');
                            if Item.FindFirst then
                                ILEGSM_L2 := Item."Paper GSM" * Rec_ILEL2."Take Up";
                        end;
                    end;

                    if ILEGSM_F2 = 0 then begin
                        Rec_ILEF2.Reset;
                        Rec_ILEF2.SetCurrentKey(Rec_ILEF2."Paper GSM");
                        ;
                        Rec_ILEF2.SetRange(Rec_ILEF2."Item No.", "Item Ledger Entry"."Item No.");
                        Rec_ILEF2.SetRange(Rec_ILEF2."Order No.", "Item Ledger Entry"."Order No.");
                        Rec_ILEF2.SetRange(Rec_ILEF2."Order Line No.", "Item Ledger Entry"."Order Line No.");
                        Rec_ILEF2.SetRange(Rec_ILEF2."Paper Position", Rec_ILEF2."Paper Position"::Flute2);
                        if Rec_ILEF2.FindLast then begin
                            Item.Reset;
                            Item.SetRange(Item."No.", Rec_ILEF2."Item No.");
                            Item.SetFilter(Item."Inventory Posting Group", 'PAPER');
                            if Item.FindFirst then
                                ILEGSM_F2 := Item."Paper GSM" * Rec_ILEF2."Take Up";
                        end;
                    end;

                    if ILEGSM_L3 = 0 then begin
                        Rec_ILEL3.Reset;
                        Rec_ILEL3.SetCurrentKey(Rec_ILEL3."Paper GSM");
                        ;
                        Rec_ILEL3.SetRange(Rec_ILEL3."Item No.", "Item Ledger Entry"."Item No.");
                        Rec_ILEL3.SetRange(Rec_ILEL3."Order No.", "Item Ledger Entry"."Order No.");
                        Rec_ILEL3.SetRange(Rec_ILEL3."Order Line No.", "Item Ledger Entry"."Order Line No.");
                        Rec_ILEL3.SetRange(Rec_ILEL3."Paper Position", Rec_ILEL3."Paper Position"::Liner3);
                        if Rec_ILEL3.FindLast then begin
                            Item.Reset;
                            Item.SetRange(Item."No.", Rec_ILEL3."Item No.");
                            Item.SetFilter(Item."Inventory Posting Group", 'PAPER');
                            if Item.FindFirst then
                                ILEGSM_L3 := Item."Paper GSM" * Rec_ILEL3."Take Up";
                        end;
                    end;
                    TotalILEGSM := ILEGSM_L1 + ILEGSM_F1 + ILEGSM_L2 + ILEGSM_F2 + ILEGSM_L3;
                end;
            ...
            begin
                ...
                SalesLine.Reset;
                SalesLine.SetRange(SalesLine."Document No.", "Prod. Order Line"."Sales Order No.");
                SalesLine.SetRange(SalesLine."Line No.", "Prod. Order Line"."Sales Order Line No.");
    ...
    var
        ...
        ILEFSCCategory: Text[100];
        ILEGSM: Decimal;
        POCompCost: Decimal;
        Rec_ILEL1: Record "Item Ledger Entry";
        Rec_ILEF1: Record "Item Ledger Entry";
        Rec_ILEL2: Record "Item Ledger Entry";
        Rec_ILEF2: Record "Item Ledger Entry";
        Rec_ILEL3: Record "Item Ledger Entry";
        ILEGSM_L1: Decimal;
        ILEGSM_F1: Decimal;
        ILEGSM_L2: Decimal;
        ILEGSM_F2: Decimal;
