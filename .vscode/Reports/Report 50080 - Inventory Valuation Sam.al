report 50080 "Inventory Valuation Sam"
{
    // version NAVW18.00

    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Reports/Inventory Valuation Sam.rdl';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(ItemWeight; Round(ItemWeight, 0.01))
            {
            }
            ...
            var
                ItemLedgerD: Record "Item Ledger Entry";
            begin
                ...
                ItemWeight := 0;
                ItemLedgerD.Reset;
                ItemLedgerD.SetRange(ItemLedgerD."Item No.", "No.");
                ItemLedgerD.SetFilter(ItemLedgerD."Remaining Quantity", '<>0');
                if ItemLedgerD.FindFirst then begin
                    repeat
                        ItemWeight += (ItemLedgerD."Actual Output Weight" / ItemLedgerD.Quantity) * ItemLedgerD."Remaining Quantity";
                    until ItemLedgerD.Next = 0;
                end;
            end;
