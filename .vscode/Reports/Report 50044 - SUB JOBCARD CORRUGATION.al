report 50044 "SUB JOBCARD CORRUGATION"
{
    // version Production/Sadaf

    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Reports/SUB JOBCARD CORRUGATION.rdl';
    ...
    dataset
    {
        dataitem("Prod. Order Line"; "Prod. Order Line")
        {
            ...
            dataitem("Production Order"; "Production Order")
            {
                ...
                begin
                    ...
                    if EST_HEADER.FindFirst then begin
                        ...
                        QTY_FG := EST_HEADER."Quantity Per FG";
            ...
            dataitem("Product Design Special Descrip"; "Product Design Special Descrip")
            {
                ...
                DataItemTableView = SORTING ("No.", "Line No.") ORDER(Ascending) WHERE (Category = FILTER ("Special Instruction" | "Sub Job Detail" | "Sp. Instruction SubJob Corrugation"));
