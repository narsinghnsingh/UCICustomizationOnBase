table 50052 "Posted Product Design Header"
{
    ...
    fields
    {
        ...
        field(9019; PaperCombination; Text[50])
        {
        }
        field(9020; "Old Estimate No."; Code[20])
        {
        }
        field(9021; "Entry No."; Integer)
        {
        }
    }
    ...
    keys
    {
        key(Key1; "Product Design Type", "Product Design No.", "Sub Comp No.", "Entry No.")
        {
        }
    }
    ...
    begin
        ...
        if EstimationHeaderMain.FindFirst then begin
            ...
            if EstimateLine.FindFirst then begin
                MfgSetup.Get;
                repeat
                    EstimateLine."Paper Weight (gms)" := ((EstimationHeaderMain."Roll Width (mm)" * (EstimationHeaderMain."Cut Size (mm)" * "No. of Joint") * EstimateLine.GSM * MfgSetup."Scrap % for Estimation" * EstimateLine."Take Up"))
                                                        / (1000000);
            ...
            EstimationHeaderMain."No. of Die Cut Ups") / (1000000);
    ...
    begin
        ...
        if EstimationHeaderSub.FindFirst then begin
            repeat
                ...
                EstimationHeaderSub."No. of Die Cut Ups") / (1000000);
    ...
    var
        TempGSMTypeIdentifier: Code[100];
        TempDeckleSize: Decimal;
        ProductDesignHeader: Record "Product Design Header";
