table 50042 "Production Schedule Line"
{
    ...
    fields
    {
        ...
        field(11; "Quantity To Schedule"; Decimal)
        {
            ...
            begin
                ...
                "Box Quantity to Schedule" := Round((("Quantity To Schedule" * "No of Die Cut") / "No. of Joint"), 1, '>');
            end;
        }
        ...
        field(44; "FG Item Number"; Code[20])
        {
            Editable = false;
            TableRelation = Item."No.";
        }
        field(45; "FG Item Description"; Text[250])
        {
            Editable = false;
        }
        field(46; "FG Item Inventory"; Decimal)
        {
            CalcFormula = Sum ("Item Ledger Entry".Quantity WHERE ("Item No." = FIELD ("FG Item Number")));
            Editable = false;
        ...
        field(64; "Qty to Schedule Net Weight"; Decimal)
        {
            Editable = false;
        }
        field(65; "Qty to Schedule M2 Weight"; Decimal)
        {
            Editable = false;
        }
        field(66; "Box Quantity to Schedule"; Decimal)
        {
            Editable = false;
        }
        field(100; "DB Paper"; Code[30])
        {
            Editable = false;
        }
        field(101; "1M Paper"; Code[30])
        {
            Editable = false;
        }
        field(102; "1L Paper"; Code[30])
        {
            Editable = false;
        }
        field(103; "2M Paper"; Code[30])
        {
            Editable = false;
        }
        field(105; "2L Paper"; Code[30])
        {
            Editable = false;
        }
        field(106; "3M Paper"; Code[30])
        {
            Editable = false;
        }
        field(107; "3L paper"; Code[30])
        {
            Editable = false;
        }
        ...
        field(504; "Re-Publish Component"; Boolean)
        {
        }
        ...
        field(2002; "Prod. Comp Line Aval"; Boolean)
        {
            CalcFormula = Exist ("Prod. Order Component" WHERE ("Prod Schedule No." = FIELD ("Schedule No."),
                                                               "Prod. Order No." = FIELD ("Prod. Order No."),
                                                               "Prod. Order Line No." = FIELD ("Prod. Order Line No."),
        ...
        field(2003; "Secondary Updated Line"; Boolean)
        {
            Editable = false;
        }
        field(2004; "Secondary Updated By"; Text[50])
        {
            Editable = false;
        }
        field(2005; "Job Status"; Option)
        {
        ...
        field(2006; "Extra Trim Actual"; Decimal)
        {
            Editable = false;
        }
        field(2007; "Extra Trim Wt. Actual"; Decimal)
        {
            Editable = false;
        }
    }
    ...
    keys
    {
        ...
        key(Key4; "Schedule No.", Flute, "No. Of Ply", "Top Colour", "FG GSM", "Qty to Schedule Net Weight", "Deckle Size Schedule(mm)")
        {
        }
        key(Key5; "Schedule No.", Flute, "No. Of Ply", "Deckle Size Schedule(mm)", "Top Colour", "Qty to Schedule Net Weight")
        {
        }
    }
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "Schedule No.", "Prod. Order No.", "Prod. Order Line No.", "Prod. Order Quanity", "Quantity To Schedule", "Item Code", "Item Description", "Customer Name")
        {
        }
    }
