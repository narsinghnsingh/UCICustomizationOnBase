page 50039 "Cash Payment Voucher"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control5; "Voucher Narration New")
            {
                ShowFilter = false;
    ...
    begin
        ...
        SubsCribs.TemplateSelectionForVouchers(PAGE::"Cash Payment Voucher", false, 2, Rec, JnlSelected);
