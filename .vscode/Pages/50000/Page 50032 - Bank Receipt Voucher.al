page 50032 "Bank Receipt Voucher"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control17; "Voucher Narration New")
            {
                ShowFilter = false;
    ...
    begin
        ...
        Subs.TemplateSelectionForVouchers(PAGE::"Bank Receipt Voucher", false, 3, Rec, JnlSelected);
    ...
    begin
        Subs.CalcTotDebitTotCreditAmount(Rec, TotalDebitAmount, TotalCreditAmount, false);
    end;
